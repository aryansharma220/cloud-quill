      ...
      <Dialog open={isTableModalOpen} onOpenChange={setTableModalOpen}>
        <DialogContent>
          ...
          <div className="flex gap-4">
            <div>
              <label htmlFor="rows" className="block mb-2 text-sm font-medium">
                Rows:
              </label>
              <Input
                id="rows"
            ...
            <div>
              <label htmlFor="cols" className="block mb-2 text-sm font-medium">
                Columns:
              </label>
              <Input
                id="cols"
                ...
                <MenubarContent>
                  <MenubarSub>
                    ...
                    <MenubarSubContent>
                      ...
                      <MenubarItem onClick={() => setTableModalOpen(true)}>
                        Custom Size
                      </MenubarItem>
                    </MenubarSubContent>
                  </MenubarSub>
                  ...
                  <MenubarSub>
                    ...
                    <MenubarSubContent>
                      ...
                      >
                        ...
                        Strikethrough &nbsp;
                        <MenubarShortcut>Alt+K</MenubarShortcut>
                      </MenubarItem>
                    </MenubarSubContent>
                  </MenubarSub>
                  <MenubarSeparator />
