...
const Marker = ({
  ...
  return (
    <div
      className="absolute top-0 h-full w-1 cursor-ew-resize z-[5] group -ml-2"
      style={{ [isLeft ? "left" : "right"]: `${position}px` }}
      onMouseDown={onMouseDown}
      onDoubleClick={onDoubleClick}
    >
      <FaCaretDown className="absolute top-0 h-full fill-blue-500 left-1/2 transform -translate-x-1/2 group-hover:fill-blue-600" />
